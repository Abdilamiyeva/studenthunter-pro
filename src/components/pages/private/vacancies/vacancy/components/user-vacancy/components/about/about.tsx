export const About = () => (
  <section id="about" className="section border border-blue-4 my-10 sm:my-20 rounded-2xl py-4 px-5 sm:py-6 sm:px-8">
    <h3 className="text-xl font-bold leading-7">About job</h3>
    ...
    <p className="text-sm font-bold leading-5 mb-1.5">Responsibilites:</p>
    <ul className="text-sm text-blue-1 list-[square] list-inside mb-5">
