...
export const UserRow = ({index}: Props) => (
  <TableRow>
    ...
    <TableCell className="text-blue-1 text-sm font-medium leading-5 text-center">Computer Science</TableCell>
    <TableCell className="text-blue-1 text-sm font-medium leading-5 text-center">---</TableCell>
    ...
    <TableCell className="text-blue-1 text-sm font-medium leading-5">
      <div className="bg-orange text-white py-0.5 px-3 rounded text-sm font-medium leading-5 w-max mx-auto">
        Rejected
      </div>
    </TableCell>
    <TableCell className="text-blue-1 text-sm font-medium leading-5">
