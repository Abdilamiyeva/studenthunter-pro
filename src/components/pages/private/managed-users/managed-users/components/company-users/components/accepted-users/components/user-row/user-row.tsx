...
import {MailIcon, ProfileIcon, RejectedUserIcon, ShortlistedUserIcon} from '@/icons'
...
export const UserRow = ({index}: Props) => (
  <TableRow>
    ...
    <TableCell>
      <div className="bg-green text-white w-max mx-auto px-3 py-0.5 text-sm font-medium leading-5 rounded">
        Accepted
      </div>
    </TableCell>
    <TableCell>
