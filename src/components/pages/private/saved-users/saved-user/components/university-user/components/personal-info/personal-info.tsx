...
import {Edit2Icon, FacebookIcon, InstagramIcon, LinkedinIcon, MailIcon, TelegramIcon} from '@/icons'
    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-y-4">
      <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-7">
        <Image
          ...
          alt="Demo user"
          imageClassName="w-[120px] h-[120px] rounded-full border border-blue"
        />
        <div className="flex flex-col w-full sm:w-auto">
          ...
          <div className="flex justify-start gap-5 mt-4">
            <div className="relative text-sm font-semibold text-white leading-5 px-3 py-0.5 rounded-sm w-max md:mx-auto bg-green">
              Active
              <button
                type="button"
                className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-white text-blue-1 border border-blue-1 rounded-full grid place-content-center"
              >
      ...
      <div className="grid sm:grid-cols-2 gap-y-6">
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="font-bold leading-6 break-all">Sevinch</p>
          </div>
          <div>
