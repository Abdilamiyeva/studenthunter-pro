import {Button, Image, Table} from '@/components/common'
...
export const SavedCompanies = () => (
  <div>
    <h3 className="text-2xl font-bold leading-8.5 mb-5">Saved Companies</h3>
    <Table>
      <TableHeader>
        <TableHead>
            ...
            <TableCell>
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="rounded px-3 py-1 text-sm font-medium leading-4 text-white w-max bg-blue-1">
                    Saved
                  </div>
                </div>
              </div>
