...
export const TuitionFee = ({program, selectProgram}: Props) => (
    ...
    {!selectProgram ? (
      ...
      <React.Fragment>
        <div className="flex gap-x-4">
          <p className="text-xs md:text-sm text-blue-2 font-normal leading-normal">
        ...
        <div className="p-6 bg-blue-7 my-5">
          <div className="inline-flex  p-4 items-center gap-x-1 rounded-lg border border-blue-4">
            ...
            <span className="text-xs md:text-sm">
              / <span className="leading-3 text-blue-3">year</span>
            </span>
          </div>
          <p className="text-xs font-normal leading-3 text-blue-2 mt-2">{program?.fee_description}</p>
        </div>
      </React.Fragment>
    )}
  </div>
